...
export const HeroSection = () => (
  <section className="relative min-h-[90vh] flex items-center pt-16 section-navy">
    {/* Ambient glow */}
    <div className="absolute top-0 right-0 w-2/3 h-full opacity-40 pointer-events-none"
      style={{
        background: "radial-gradient(ellipse 70% 80% at 80% 40%, hsl(186 79% 47% / 0.2) 0%, transparent 60%)"
      }}
    />
    ...
    <div className="container mx-auto px-6 lg:px-12 py-16 md:py-24">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
        <div className="lg:col-span-7 space-y-7">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-grotesk font-medium leading-[1.08] tracking-tight">
          ...
          <div className="flex flex-wrap gap-3 pt-1">
            <Link
              to="/candidater"
              className="bg-primary text-primary-foreground px-6 py-3 rounded-lg font-grotesk font-medium text-sm hover:opacity-90 transition-opacity"
            >
              Devenir Futuriste →
            </Link>
            <a
              href="#tension"
              className="border border-border text-foreground px-6 py-3 rounded-lg font-grotesk font-medium text-sm hover:bg-secondary/50 transition-colors flex items-center gap-2"
            >
