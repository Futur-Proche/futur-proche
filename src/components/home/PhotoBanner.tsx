      ...
      <div ref={ref} className="container mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <figure>
            ...
            <figcaption className="mt-2 font-mono text-[10px] uppercase tracking-[1.2px] text-center" style={{ color: "hsl(228 15% 55%)" }}>La communauté réunie lors d'un After Proche</figcaption>
          </figure>
          <figure>
            <div className="aspect-[4/3] rounded-lg overflow-hidden">
            ...
            <figcaption className="mt-2 font-mono text-[10px] uppercase tracking-[1.2px] text-center" style={{ color: "hsl(228 15% 55%)" }}>Speakers & tables rondes entre pairs</figcaption>
          </figure>
          <figure>
            <div className="aspect-[4/3] rounded-lg overflow-hidden">
