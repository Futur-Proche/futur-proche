    ...
    <div className="container mx-auto px-6 lg:px-12 py-20 md:py-28">
      ...
      <div className="flex flex-wrap gap-3 justify-center max-w-3xl mx-auto">
        {placeholderMembers.map((m) => (
          <div
            key={m.id}
            className="w-14 h-14 rounded-full flex items-center justify-center text-xs font-mono font-medium border"
            style={{
              background: "hsl(228 20% 92%)",
              borderColor: "hsl(228 10% 85%)",
              color: "hsl(228 15% 55%)",
            }}
          >
            {m.initials}
      ...
      <p className="text-center text-xs mt-6 font-mono uppercase tracking-wider" style={{ color: "hsl(228 15% 60%)" }}>
