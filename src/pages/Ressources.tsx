...
const podcastEpisodes = [
  {
    title: "Communauté : side project ou game changer ?",
    duration: "1h10",
    date: "20 avril 2026",
    season: "S02E04",
    cover: "https://image.ausha.co/SofdbYRiI2UUtIM5HsY7dPECBwYHRzbv2QnqQ3TB_400x400.jpeg",
    url: "https://podcast.ausha.co/futur-proche/communaute-side-project-ou-game-changer",
    guests: "Faustine Rohr-Lacoste (Hexa), Ambre Prigent (Crème de la Crème), Anne Dumas (Le Wagon)",
  },
  {
    title: "Sans Brand, c'est déjà la fin (B2C, B2B, même combat)",
    duration: "53min",
    date: "19 mars 2026",
    season: "S02E03",
    cover: "https://image.ausha.co/ZQEu3OiIvTsPTDXpbGwFwxdLvccIgvKl8KaLT7bi_400x400.jpeg",
    url: "https://podcast.ausha.co/futur-proche/sans-brand-c-est-deja-la-fin-b2c-b2b-meme-combat",
    guests: "Florian Deveaux (ex-Bonne Gueule), Nicolas Hurbin (Back Market), Sophie Malka (Consultante)",
  },
  {
    title: "Outbound : strat' premium ou spam organisé ?",
    duration: "1h10",
    date: "17 février 2026",
    season: "S02E02",
    cover: "https://image.ausha.co/OaNBqk8mcTc3ftZvP15bBNYXmJ9XWgHYXPXzk56H_400x400.jpeg",
    url: "https://podcast.ausha.co/futur-proche/outbound-strat-premium-ou-spam-organise",
    guests: "Romain Rougier (Outbound Expert), Julien Rio (VP Intl. Marketing), Baptiste Le Fur (Agorapulse)",
  },
  {
    title: "Impact & business : et si agir rapportait gros ?",
    duration: "1h14",
    date: "20 janvier 2026",
    season: "S02E01",
    cover: "https://image.ausha.co/Eksf2zUBmpsIdc7mdq6iJDgCekxUYU7gLtcLSowh_400x400.jpeg",
    url: "https://podcast.ausha.co/futur-proche/impact-business-et-si-agir-rapportait-gros",
    guests: "Hélène Draoulec (Phenix), Manon Le Bourdiec (Sami), Pauline Vettier (RP énergie durable)",
  },
  {
    title: "SEO / GEO : la fin d'une ère ?",
    duration: "1h07",
    date: "30 novembre 2025",
    season: "S01E11",
    cover: "https://image.ausha.co/HDfakcC83nPpShpTLnhebEUre4y0st10pD9HKOvq_400x400.jpeg",
    url: "https://podcast.ausha.co/futur-proche/seo-geo-la-fin-d-une-ere",
    guests: "Edouard Hocde (Captain Contrat), Valentine Chelius (Alan), Alexandre Courbin (Eskimoz)",
  },
  {
    title: "L'international, c'est pas si loin !",
    duration: "1h03",
    date: "16 octobre 2025",
    season: "S01E10",
    cover: "https://image.ausha.co/vm6cK7QIaPG0iB6GAzrSPgEPiUQRXwSh2CCEmBWQ_400x400.jpeg",
    url: "https://podcast.ausha.co/futur-proche/marketing-international",
    guests: "Kevin Viehweger (ex-Withings), Sandrine Puichaffret (fractional CXO), Dorothée Grou (ex-Chivas)",
  },
];

const platformLinks = [
  { label: "Spotify", href: "https://open.spotify.com/show/4Fzm7K5joIHBDiUgjz66vn" },
  { label: "Apple Podcasts", href: "https://podcasts.apple.com/au/podcast/futur-proche/id1778946164" },
  { label: "YouTube", href: "https://www.youtube.com/@futurproche-marketing" },
  { label: "Ausha", href: "https://podcast.ausha.co/futur-proche" },
];
...
const Ressources = () => {
  ...
  const maxStart = Math.max(0, podcastEpisodes.length - visibleCount);

  const prev = () => setCurrentEp((c) => Math.max(0, c - 1));
  const next = () => setCurrentEp((c) => Math.min(maxStart, c + 1));
          ...
          <div className="container mx-auto px-6 lg:px-12 py-20 md:py-28">
            ...
            <div className="flex flex-wrap items-center gap-6 mb-8">
              <div className="flex items-center gap-2">
                ...
                <span className="font-grotesk font-semibold" style={{ color: "hsl(228 56% 10%)" }}>23 épisodes</span>
            ...
            {/* Carrousel des derniers épisodes */}
            <div className="mt-10">
              <div className="flex items-center justify-between mb-6">
                <h3 className="font-grotesk font-semibold text-lg" style={{ color: "hsl(228 56% 10%)" }}>
                  Derniers épisodes
                </h3>
                <div className="flex items-center gap-2">
                  <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {podcastEpisodes.slice(currentEp, currentEp + visibleCount).map((ep) => (
                  <a
                    key={ep.url}
                    href={ep.url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group rounded-xl overflow-hidden card-lift"
                    style={{ background: "white", border: "1px solid hsl(228 10% 85%)" }}
                  >
                    <div className="aspect-square overflow-hidden relative">
                      ...
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors flex items-center justify-center">
                        <div className="w-14 h-14 rounded-full bg-white/90 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity shadow-lg">
                          <Play size={24} style={{ color: "hsl(228 56% 10%)" }} className="ml-1" />
                        </div>
                      </div>
                    </div>
                    <div className="p-5">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="font-mono text-[10px] uppercase tracking-wider px-2 py-0.5 rounded-full" style={{ background: "hsl(186 79% 47% / 0.12)", color: "hsl(186 60% 32%)" }}>
                          {ep.season}
                        </span>
                        <span className="font-mono text-[10px] tracking-wider" style={{ color: "hsl(228 15% 55%)" }}>
                          {ep.duration}
                        </span>
                      </div>
                      <h4 className="font-grotesk font-semibold text-sm leading-snug mb-2 line-clamp-2" style={{ color: "hsl(228 56% 10%)" }}>
                        {ep.title}
                      </h4>
                      <p className="text-xs leading-relaxed line-clamp-2" style={{ color: "hsl(228 15% 55%)" }}>
                        {ep.guests}
                      </p>
                      <p className="text-[10px] mt-2 font-mono" style={{ color: "hsl(228 15% 65%)" }}>
                        {ep.date}
                      </p>
                    </div>
                  </a>
              ...
              <div className="flex justify-center gap-1.5 mt-6">
                {Array.from({ length: maxStart + 1 }).map((_, i) => (
                  <button
                    ...
                    style={{ background: i === currentEp ? "hsl(186 79% 47%)" : "hsl(228 10% 80%)" }}
                  />
                ))}
              </div>
            </div>
