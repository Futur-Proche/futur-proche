    ...
    <>
      ...
      <main>
        ...
        <section className="section-navy relative overflow-hidden">
          ...
          <div className="container relative z-10 mx-auto px-6 lg:px-12 pt-32 pb-20 md:pt-40 md:pb-28">
            <div className="max-w-4xl">
              <span className="section-label mb-4 inline-block">— Rejoindre la communauté</span>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-grotesk font-bold tracking-tight text-white mt-3 mb-5 leading-[1.12]">
                Les meilleures décisions Marketing<br className="hidden md:block" /> se prennent{" "}
          ...
          <div className="container mx-auto px-6 lg:px-12 py-14 md:py-18">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <div className="group relative overflow-hidden rounded-2xl">
                ...
                <p className="absolute bottom-4 left-4 text-xs font-mono uppercase tracking-wider text-white/70">
                  L'équipe fondatrice
                </p>
              </div>
              <div className="group relative overflow-hidden rounded-2xl">
          ...
          <div className="container mx-auto px-6 lg:px-12 py-16 md:py-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto mb-16">
              {reassurance.map((r) => (
                <div
                  key={r.title}
                  className="bg-white rounded-xl p-6 card-lift group"
                ...
                >
                  <div
                    ...
                    style={{ background: "hsl(186 79% 47% / 0.1)" }}
                  >
            ...
            {/* ── Témoignage FOMO ── */}
            <div
              className="max-w-2xl mx-auto rounded-2xl p-8 mb-16 text-center relative overflow-hidden"
              style={{ background: "hsl(228 56% 10%)" }}
            >
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary via-primary/50 to-transparent" />
              <p className="font-serif-accent italic text-white/80 text-lg md:text-xl leading-relaxed mb-4">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-grotesk font-bold tracking-tight" style={{ color: "hsl(228 56% 10%)" }}>
                  Déposez votre candidature
                </h2>
                <p className="text-sm mt-2" style={{ color: "hsl(228 15% 45%)" }}>
                  2 minutes · Gratuit · Réponse sous 48h
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="prenom" className={labelClass} style={{ color: "hsl(228 56% 10%)" }}>Prénom</label>
                    <input id="prenom" name="prenom" type="text" required value={form.prenom} onChange={handleChange} className={inputClass} style={{ borderColor: "hsl(228 10% 85%)", color: "hsl(228 56% 10%)" }} />
                  </div>
                  <div>
                    <label htmlFor="nom" className={labelClass} style={{ color: "hsl(228 56% 10%)" }}>Nom</label>
                    <input id="nom" name="nom" type="text" required value={form.nom} onChange={handleChange} className={inputClass} style={{ borderColor: "hsl(228 10% 85%)", color: "hsl(228 56% 10%)" }} />
                  </div>
                </div>

                <div>
                  <label htmlFor="poste" className={labelClass} style={{ color: "hsl(228 56% 10%)" }}>Poste</label>
                  <select id="poste" name="poste" required value={form.poste} onChange={handleChange} className={inputClass} style={{ borderColor: "hsl(228 10% 85%)", color: form.poste ? "hsl(228 56% 10%)" : "hsl(228 15% 55%)" }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="entreprise" className={labelClass} style={{ color: "hsl(228 56% 10%)" }}>Entreprise</label>
                    <input id="entreprise" name="entreprise" type="text" required value={form.entreprise} onChange={handleChange} placeholder="Si indépendant·e, ne rien indiquer" className={inputClass} style={{ borderColor: "hsl(228 10% 85%)", color: "hsl(228 56% 10%)" }} />
                  </div>
                  <div>
                    <label htmlFor="secteur" className={labelClass} style={{ color: "hsl(228 56% 10%)" }}>Secteur</label>
                    <select id="secteur" name="secteur" required value={form.secteur} onChange={handleChange} className={inputClass} style={{ borderColor: "hsl(228 10% 85%)", color: form.secteur ? "hsl(228 56% 10%)" : "hsl(228 15% 55%)" }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="email" className={labelClass} style={{ color: "hsl(228 56% 10%)" }}>E-mail</label>
                    <input id="email" name="email" type="email" required value={form.email} onChange={handleChange} className={inputClass} style={{ borderColor: "hsl(228 10% 85%)", color: "hsl(228 56% 10%)" }} />
                  </div>
                  <div>
                    <label htmlFor="telephone" className={labelClass} style={{ color: "hsl(228 56% 10%)" }}>Téléphone</label>
                    <input id="telephone" name="telephone" type="tel" required value={form.telephone} onChange={handleChange} placeholder="Pour le groupe WhatsApp" className={inputClass} style={{ borderColor: "hsl(228 10% 85%)", color: "hsl(228 56% 10%)" }} />
                  </div>
                </div>

                <div>
                  <label htmlFor="linkedin" className={labelClass} style={{ color: "hsl(228 56% 10%)" }}>Profil LinkedIn</label>
                  <input id="linkedin" name="linkedin" type="url" value={form.linkedin} onChange={handleChange} placeholder="https://linkedin.com/in/..." className={inputClass} style={{ borderColor: "hsl(228 10% 85%)", color: "hsl(228 56% 10%)" }} />
                </div>

                <div>
                  <label htmlFor="cooptation" className={labelClass} style={{ color: "hsl(228 56% 10%)" }}>Coopté·e par un membre ?</label>
                  <input id="cooptation" name="cooptation" type="text" value={form.cooptation} onChange={handleChange} placeholder="Nom du membre (facultatif — mais ça accélère 😉)" className={inputClass} style={{ borderColor: "hsl(228 10% 85%)", color: "hsl(228 56% 10%)" }} />
                </div>

                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full px-7 py-4 rounded-xl font-grotesk font-semibold text-base transition-all duration-300 hover:scale-[1.01] hover:shadow-lg disabled:opacity-50 disabled:hover:scale-100"
                ...
                <div className="flex items-center justify-center gap-6 pt-2">
                  <span className="text-xs flex items-center gap-1.5" style={{ color: "hsl(228 15% 55%)" }}>
                ...
                <p className="text-center text-xs mt-2" style={{ color: "hsl(228 15% 55%)" }}>
